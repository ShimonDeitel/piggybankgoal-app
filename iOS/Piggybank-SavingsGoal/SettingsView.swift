    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("Piggybank - Savings Goal Pro") {
                    if purchases.isPro {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/piggybankgoal-app/privacy.html")!)
                    Link("Terms of Use", destination: URL(string: "https://shimondeitel.github.io/piggybankgoal-app/terms.html")!)
                    Text("Piggybank - Savings Goal 1.0")
